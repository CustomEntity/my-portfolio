...
"
>
    <div class="flex items-center justify-between w-full h-[54px]">
        ...
        <div class="flex items-center gap-7">
            <button
                    class="focus:bg-accent-dark/[0.1] rounded-sm focus:outline-none p-1 select-none"
    ...
    {#if isNavBarOpen}
        <div
                ...
                class="flex flex-col absolute justify-center h-full pl-7 gap-8 {isNavBarOpen ? 'display:flex' : 'display:hidden'}">
            <a href="/blog" class="flex items-center gap-2">
                <svg viewBox="0 0 24 24" style="width:1.35rem;height:1.35rem" role="presentation"
                    ...
                    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zM9.5 8.5h5v1h-5v-1zm0 2h5v1h-5v-1zm0 2h5v1h-5v-1zm0 2h3v1h-3v-1z"
            ...
            <a href="/blog" class="flex items-center gap-2">
                <svg viewBox="0 0 24 24" style="width:1.35rem;height:1.35rem" role="presentation"
                     class="text-white fill-white">
                    <path d="M12 2L1 21h22M12 2v16M12 6l7.5 5M12 6L4.5 11M12 10l7.5 5M12 10L4.5 15M12 14l7.5 5M12 14L4.5 19"
