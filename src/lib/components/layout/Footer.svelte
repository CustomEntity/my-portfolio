    ...
    <div class="flex flex-col border-t border-divider p-4 gap-6">
        <div class="grid grid-cols-2 gap-6">
            <div class="flex flex-col gap-3">
                <a href="/about" class="text-tertiary-txt font-medium">About</a>
                <a href="/blog" class="text-tertiary-txt font-medium">Blog</a>
                <a href="/projects" class="text-tertiary-txt font-medium">Projects</a>
            </div>
            <div class="flex flex-col gap-3">
                <a href="vouches" class="text-tertiary-txt font-medium">Vouches</a>
                <a href="/hireme" class="text-tertiary-txt font-medium">Hire me</a>
                {#if track && track.item}
                    <MusicTitle
