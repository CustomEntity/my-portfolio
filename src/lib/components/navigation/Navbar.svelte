...
>
	<div class="flex items-center justify-between w-full h-[42px]">
		...
		>
			<img width="24" height="24" src="/favicon.png" alt="Flavio Moreno" class="w-6 h-6" />
			<span
				...
				<ul class="flex items-center gap-2">
					<li class="relative h-full">
						<NavbarButton
							...
							spanClass={pathName === '/about'
								? 'text-transparent bg-gradient-to-r bg-clip-text saturate-150 from-gradient-blue to-gradient-green'
								: ''}
					...
					<li>
						<NavbarButton
							containerClass={pathName.includes('/blog') ? 'bg-accent-dark/[0.1]' : ''}
							spanClass={pathName.includes('/blog')
								? 'text-transparent bg-gradient-to-r bg-clip-text saturate-150 from-gradient-yellow to-gradient-orange'
								: ''}
					...
					<li>
						<NavbarButton
							...
							spanClass={pathName === '/projects'
								? 'text-transparent bg-gradient-to-r bg-clip-text saturate-150 from-gradient-red to-gradient-purple'
								: ''}
					...
					<li>
						<NavbarButton
							...
							spanClass={pathName === '/contact'
								? 'text-transparent bg-gradient-to-r bg-clip-text saturate-150 from-gradient-brand to-gradient-blue'
								: ''}
	...
	{#if isNavBarOpen}
		...
		>
			...
			>
				<span
					class="bg-gradient-to-r bg-clip-text saturate-150 {pathName === '/about'
						? 'text-transparent from-gradient-blue to-gradient-green'
						: 'text-secondary-txt'}"
			...
			>
				<span
					class="bg-gradient-to-r bg-clip-text saturate-150 {pathName === '/blog'
						? 'text-transparent from-gradient-yellow to-gradient-orange'
						: 'text-secondary-txt'}"
					style="display: inline-block; vertical-align: top; text-decoration: inherit; text-wrap: balance;"
				>
					Blog</span
			...
			>
				<span
					class="bg-gradient-to-r bg-clip-text saturate-150 {pathName === '/projects'
						? 'text-transparent from-gradient-red to-gradient-purple'
						: 'text-secondary-txt'}"
					style="display: inline-block; vertical-align: top; text-decoration: inherit; text-wrap: balance;"
				>
					Projects</span
			...
			>
				<span
					class="bg-gradient-to-r bg-clip-text saturate-150 {pathName === '/contact'
						? 'text-transparent from-gradient-brand to-gradient-blue'
						: 'text-secondary-txt'}"
					style="display: inline-block; vertical-align: top; text-decoration: inherit; text-wrap: balance;"
				>
					Contact</span
