...
<!--<div class="flex flex-wrap gap-10">
	<ul class="flex flex-col gap-3">
		<li class=" text-tertiary-txt font-medium outline-none">About</li>
		<li class=" text-tertiary-txt font-medium outline-none">Blog</li>
		<li class=" text-tertiary-txt font-medium outline-none">Projects</li>
	</ul>
</div>-->
	...
	<div class="flex flex-col border-t border-divider p-4 gap-6">
		<div class="grid grid-cols-2 gap-6">
			<div class="flex flex-col gap-3">
				<a href="/about" class="text-tertiary-txt font-medium outline-none">About</a>
				<a href="/blog" class="text-tertiary-txt font-medium outline-none">Blog</a>
				<a href="/projects" class="text-tertiary-txt font-medium outline-none">Projects</a>
			</div>
			<div class="flex flex-col gap-3">
				<a href="vouches" class="text-tertiary-txt font-medium outline-none">Vouches</a>
				<a href="/hireme" class="text-tertiary-txt font-medium outline-none">Hire me</a>
				{#if track && track.item}
					<MusicTitle
						image={track.item && track.item.album.images[2].url}
						title="{track.item && track.item.name} - {track.item && track.item.artists[0].name}"
						url={track.item && track.item.external_urls.spotify}
					/>
				{/if}
			</div>
		</div>
